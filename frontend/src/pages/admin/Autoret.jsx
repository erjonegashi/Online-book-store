...
import { Search, UserCircle, PenLine, AlertTriangle } from 'lucide-react';
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gray-100 overflow-hidden flex items-center justify-center shrink-0 border border-gray-200">
                  {form.foto_url
                    ...
                    : <UserCircle size={28} className="text-gray-300" strokeWidth={1.25} />}
                </div>
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4">
            <div className="w-11 h-11 rounded-full bg-red-100 flex items-center justify-center mb-4"><PenLine size={20} className="text-red-600" strokeWidth={1.75} /></div>
