...
export default function Books() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setCategories(Array.isArray(k.data) ? k.data : []);
        ...
        <div className="flex-1 min-w-0">
          ...
          {loading ? (
            ...
            <div className="text-center py-24 bg-white rounded-xl border border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-1">Could not connect to the server</h3>
              <p className="text-gray-500 text-sm">Make sure the backend is running: <code className="bg-gray-100 px-1 rounded text-xs">cd backend &amp;&amp; npm run dev</code></p>
            </div>
          ) : paginated.length === 0 ? (
            <div className="text-center py-24 bg-white rounded-xl border border-gray-200">
              <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-4"><Search size={24} className="text-gray-300" strokeWidth={1.5} /></div>
