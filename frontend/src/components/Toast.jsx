...
const CONFIGS = {
  success: { bg: 'bg-emerald-600', border: 'border-emerald-500', Icon: Check,        label: 'Success' },
  error:   { bg: 'bg-red-600',     border: 'border-red-500',     Icon: AlertCircle,  label: 'Error'   },
  info:    { bg: 'bg-blue-600',    border: 'border-blue-500',    Icon: Info,         label: 'Info'    },
};
