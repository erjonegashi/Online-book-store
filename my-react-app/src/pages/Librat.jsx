                  ...
                  <tr key={b.liber_id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-2">
                      {imgSrc(b.foto_url)
                        ...
                        : null}
                      <div className={`w-10 h-14 bg-gray-100 rounded flex items-center justify-center text-xl ${imgSrc(b.foto_url) ? 'hidden' : ''}`}>📖</div>
                    </td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto p-6 space-y-4 flex-1">
              ...
              <div className="flex items-start gap-4">
                <div className="w-16 h-24 bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center shrink-0 border border-gray-200">
                  {form.foto_url
                ...
                <div className="flex-1">
                  <label className="label">URL e Kopertinës</label>
                  <input type="text" value={form.foto_url} onChange={set('foto_url')}
                    placeholder="https://covers.openlibrary.org/b/isbn/..."
                    className="input" />
                  <p className="text-xs text-gray-400 mt-1">
                    Shembull: <span className="font-mono">https://covers.openlibrary.org/b/isbn/9780451524935-L.jpg</span>
                  </p>
                </div>
              </div>
