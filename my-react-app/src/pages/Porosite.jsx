          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 p-6 space-y-6">
              {detailLoading ? (
                ...
                <>
                  {detailError && (
                    <div className="p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">⚠ {detailError}</div>
                  )}
                                  ...
                                  <div className="flex items-center gap-2">
                                    {(() => {
                                      ...
                                      return book?.foto_url
                                        ...
                                        : <div className="w-7 h-10 bg-gray-100 rounded flex items-center justify-center text-sm shrink-0">📖</div>;
                                    })()}
